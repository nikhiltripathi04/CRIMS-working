...
export default function OnboardingScreen({ navigation }) {
    const completeOnboarding = async (nextScreen = 'Login') => {
        try {
            await AsyncStorage.setItem('hasOnboarded', 'true');
            console.log('Onboarding complete, flag set.');
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Build Smarter, Manage Better.</Text>
                </View>
                ...
                <View style={styles.descriptionContainer}>
                    <Text style={styles.description}>
                        Your all-in-one solution for seamless resource and inventory control in construction.
                    </Text>
                </View>
